function im = cosGrating(vhSize, cyclesPer100Pix, orientation, phase, mean, amplitude)
...
simIm = amplitude * cos(2.*pi.*(cyclesPer100Pix/100).* (sin(orientation * pi/180).*X ...
										  + cos(orientation * pi/180).*Y)  ...
