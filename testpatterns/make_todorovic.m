...
if strcmp(type, 'equal')
    cross_length= 240;
    %make vertical cross
    block( (192-(cross_length)/2): ((192-(cross_length)/2)+ cross_length), 222:270)=0.5;
    %make horizontal cross
    block( 168:216, (246-(cross_length)/2): (246-(cross_length)/2 + cross_length))= 0.5;
...
elseif strcmp(type, 'out')
    cross_length= 280;
    %make vertical cross
    block( (192-(cross_length)/2): ((192-(cross_length)/2)+ cross_length), 223:269)=0.5;
    %make horizontal cross
    block( 169:215, (246-(cross_length)/2): (246-(cross_length)/2 + cross_length))= 0.5;
end

%make the four squares
block(72:168, 126:222)=0; %make upper left hand corner square
block(216:312, 126:222)=0; %make lower left hand corner square
block(72:168, 270:366)=0; %make upper right hand corner square
block(216: 312, 270:366)=0; %make lower right hand corner square
